...
static const uint8_t seuil_majority_rule = 15;
...
void affichage_resultats() {
  if (consensus_atteint == tableau_nbre_agents[0] || consensus_atteint == tableau_nbre_agents[1]) {
