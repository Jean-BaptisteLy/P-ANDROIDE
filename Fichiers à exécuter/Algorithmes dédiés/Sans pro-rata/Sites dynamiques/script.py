...
intervalle_temps_min = 30 # à modifier de même dans le fichier .c sinon problème
...
def graphe(x,yA,yB,yGlobal,seuils):
    titre = "Evolution du nombre d'agents pour la ressource b sur "+str(nbre_runs)+" runs :"
    plt.title(titre)
    plt.xlabel("Temps en minutes")
    plt.ylabel("Pourcentage d'agents pour le site b")
