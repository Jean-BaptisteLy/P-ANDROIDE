...
static const uint8_t nbre_initial_agents_tetus = 0;
static const uint8_t seuil_changements_opinions = 3;
...
void transition_tetu() {
  if (mydata->changements_opinions == mydata->seuil_changements_opinions) {
    ...
    double proba_b;
    double tirage;
    total = mydata->changements_opinions_a + mydata->changements_opinions_b;
    proba_a = mydata->changements_opinions_a / total;
    proba_b = mydata->changements_opinions_b / total;
    ...
    else if (tirage <= proba_a + proba_b) {
      mydata->tetu = 1;
      mydata->opinion_a = 0;
      mydata->opinion_b = 1;
