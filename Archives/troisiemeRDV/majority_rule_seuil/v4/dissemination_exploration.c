      ...
      if(mydata->flag_nest) {     
        if (mydata->flag_listener == 1) {
          if(!mydata->flag_voisin_deja_rencontre) {
            mydata->opinion_a ++;
            if(mydata->cpt_voisins >= mydata->seuil && mydata->opinion_a > mydata->opinion_b && mydata->opinion_a > mydata->opinion_c) {
              set_opinion_a();
              vider_tableau_uid();
            }
          }            
          ...
          if(!mydata->flag_voisin_deja_rencontre) {
            mydata->opinion_b ++;
            if(mydata->cpt_voisins >= mydata->seuil && mydata->opinion_b > mydata->opinion_a && mydata->opinion_b > mydata->opinion_c) {
              set_opinion_b();
              vider_tableau_uid();
            }
          }  
          ...
          if(!mydata->flag_voisin_deja_rencontre) {
            mydata->opinion_c ++;
            if(mydata->cpt_voisins >= mydata->seuil && mydata->opinion_c > mydata->opinion_a && mydata->opinion_c > mydata->opinion_b) {
              set_opinion_c();
              vider_tableau_uid();
            }
          }  
...
json_t *json_state() {
  ...
  json_t* seuil = json_integer(mydata->seuil);
