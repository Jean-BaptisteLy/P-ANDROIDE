...
static const uint8_t iteration_critique_changements_opinions = 6;
...
void affichage_resultats() {
  ...
  if (consensus_courant == consensus_atteint) {
    ...
    printf("Nombre d'agents théorique pour le site a : %f \n", (double)consensus_atteint * ((double)quality_of_site_a / quality_total));
    printf("Nombre d'agents théorique pour le site b : %f \n", (double)consensus_atteint * ((double)quality_of_site_b / quality_total));
    printf("Nombre d'agents théorique pour le site c : %f \n", (double)consensus_atteint * ((double)quality_of_site_c / quality_total));
    printf("Nombre d'agents théorique pour le site d : %f \n", (double)consensus_atteint * ((double)quality_of_site_d / quality_total));
