...
intervalle_temps_min = 15 # à modifier de même dans le fichier .c sinon problème
...
def graphe(x,yA,yB,yGlobal):
    titre = "Qualité du consensus en fonction du temps sur "+str(nbre_runs)+" runs :"
    plt.title(titre)
